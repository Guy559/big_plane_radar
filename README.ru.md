...
| Символ | Что означает | ADS-B categories |
| --- | --- | --- |
| маленький треугольник | лёгкий/малый самолёт | `A1`, `A2`, `B*` |
| треугольник | обычный самолёт | `A3`, `A6`, неизвестно |
| крупный треугольник | тяжёлый/крупный самолёт | `A4`, `A5` |
| маленький `X` с хвостом | вертолёт; хвост показывает направление | `A7` |
